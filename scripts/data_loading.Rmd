...
# making our df using the chosen variable columns - theis bit dont yet work
library(dplyr)

our_data <- st_data %>%
  select(all_of(chosen_vars)

output_path <- "../data/our_data.csv"
write.csv(our_data, file = output_path, row.names = TRUE)
