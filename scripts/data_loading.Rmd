...
our_data <- our_data %>% 
  mutate(
    C1_B1 = factor(C1_B1, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B2 = factor(C1_B2, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)), 
    C1_B5 = factor(C1_B5, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)), 
    C1_B10 = factor(C1_B10, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)), 
    C1_B11 = factor(C1_B11, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1)),
    C1_B12 = factor(C1_B12, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B13 = factor(C1_B13, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B14 = factor(C1_B14, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(1, 2, 3)),
    C1_B15 = factor(C1_B15, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B16 = factor(C1_B16, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B17 = factor(C1_B17, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B18 = factor(C1_B18, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B19 = factor(C1_B19, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B20 = factor(C1_B20, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B21 = factor(C1_B21, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1)),
    C1_B22 = factor(C1_B22, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B23 = factor(C1_B23, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B24 = factor(C1_B24, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C1_B25 = factor(C1_B25, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1))
  )
...
our_data <- our_data %>% 
  mutate(
    C2_B1 = factor(C2_B1, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B2 = factor(C2_B2, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)), 
    C2_B5 = factor(C2_B5, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)), 
    C2_B10 = factor(C2_B10, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)), 
    C2_B11 = factor(C2_B11, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1)),
    C2_B12 = factor(C2_B12, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B13 = factor(C2_B13, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B14 = factor(C2_B14, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1)),
    C2_B15 = factor(C2_B15, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B16 = factor(C2_B16, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B17 = factor(C2_B17, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B18 = factor(C2_B18, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B19 = factor(C2_B19, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B20 = factor(C2_B20, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B21 = factor(C2_B21, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1)),
    C2_B22 = factor(C2_B22, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B23 = factor(C2_B23, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B24 = factor(C2_B24, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C2_B25 = factor(C2_B25, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1))
  )
...
our_data <- our_data %>% 
  mutate(
    C3_B1 = factor(C3_B1, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B2 = factor(C3_B2, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)), 
    C3_B5 = factor(C3_B5, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)), 
    C3_B10 = factor(C3_B10, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)), 
    C3_B11 = factor(C3_B11, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1)),
    C3_B12 = factor(C3_B12, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B13 = factor(C3_B13, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B14 = factor(C3_B14, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1)),
    C3_B15 = factor(C3_B15, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B16 = factor(C3_B16, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B17 = factor(C3_B17, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B18 = factor(C3_B18, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B19 = factor(C3_B19, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B20 = factor(C3_B20, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B21 = factor(C3_B21, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1)),
    C3_B22 = factor(C3_B22, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B23 = factor(C3_B23, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B24 = factor(C3_B24, levels = c("Not true", "Sort of true", "Certainly true"), labels = c(1, 2, 3)),
    C3_B25 = factor(C3_B25, levels = c("Certainly true", "Sort of true", "Not true"), labels = c(3, 2, 1))
  )
...
# Ensure label_levels is character
label_levels <- c("Never", "Seldom", "Sometimes", "Often", "Always")

# Convert selected columns to character if necessary
our_data <- our_data %>%
...
our_data <- our_data %>%
  mutate(across(c(C1_AG1, C1_AG2, C1_AG3, C1_AG4,
                  C2_AG1, C2_AG2, C2_AG3, C2_AG4,
                  C3_AG1, C3_AG2, C3_AG3, C3_AG4),
                ~ factor(.x, levels = label_levels, labels = c(1, 2, 3, 4, 5))))
...
## "FSM" #1 for no, 2 for yes

library(dplyr)

# Convert FSM column to character if necessary
our_data <- our_data %>%
  mutate(FSM = as.character(FSM))

# Apply factor transformation
our_data <- our_data %>%
  mutate(FSM = factor(FSM, levels = c("No", "Yes"), labels = c(1, 2)))
...
# check everything's as it should be
var_class <- sapply(our_data, class)
var_level <- sapply(our_data, function(x) if(is.factor(x)) paste(levels(x), collapse = ", ") else NA)
(check_df <- cbind.data.frame(var_class, var_level))

write.csv(our_data, file = "../data/our_data.csv", row.names = FALSE)

# checking the saved df loads like the old df
