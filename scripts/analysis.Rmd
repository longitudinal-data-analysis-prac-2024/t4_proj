...
# imma visualise a little first coz that's gonna help me ac understand the onlsaught of numbers the lmer have gonna give me
library(ggplot2)
...
long_data %>%
  ...
  geom_line(color = "cadetblue3", size = 1.5) +  # Change the color and thickness here
...
ggplot(long_data, aes(x = Time, y = Btotal, color = as.factor(ID))) +
  geom_line(aes(group = AGtotal)) +
  geom_point() +
  labs(color = "ID")
